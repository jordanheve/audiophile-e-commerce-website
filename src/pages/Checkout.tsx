...
export default function Checkout() {
  ...
  return (
    <div>
      <form className="p-4 pt-28 bg-zinc-50 flex flex-col gap-4">
        <GoBack />
        <div className="bg-white flex flex-col gap-4 p-4 rounded-xl">
          <h2 className="uppercase font-semibold text-3xl mb-2">Checkout</h2>
          <h4 className="text-custom-orange font-semibold uppercase text-md mt-2">Billing Details</h4>
          <InfoInput ref={nameRef} label="Name" placeholder="Alexei Ward" id="name" value={formCheckout.name} handleValue={handleChange} errorMessage={formErrors.name} required />
          <InfoInput ref={emailRef} label="Email Address" placeholder="alexei@mail.com" id="email" type="text" value={formCheckout.email} handleValue={handleChange} errorMessage={formErrors.email} required />
          <InfoInput ref={phoneRef} label="Phone Number" placeholder="+1 202-555-0136" id="phone" value={formCheckout.phone} handleValue={handleChange} errorMessage={formErrors.phone} required />
          <h4 className="text-custom-orange font-semibold uppercase text-md mt-2">Shipping Info</h4>
          <InfoInput ref={addressRef} label="Your Address" placeholder="1137 Williams Avenue" id="address" value={formCheckout.address} handleValue={handleChange} errorMessage={formErrors.address} required />
          <InfoInput ref={zipRef} label="ZIP Code" placeholder="10001" id="zip" maxLength={5} value={formCheckout.zip} handleValue={handleChange} errorMessage={formErrors.zip} required />
          <InfoInput ref={cityRef} label="City" placeholder="New York" id="city" value={formCheckout.city} handleValue={handleChange} errorMessage={formErrors.city} required />
          <InfoInput ref={countryRef} label="Country" placeholder="United States" id="country" value={formCheckout.country} handleValue={handleChange} errorMessage={formErrors.country} required />
          <h4 className="text-custom-orange font-semibold uppercase text-md mt-2">Payment Details</h4>
          <fieldset className="flex flex-col gap-2">
            ...
            {selectedPayment === 'eMoney' && (
              <div className="mt-4 flex flex-col gap-2" id="moneyInfo">
                <InfoInput ref={eMoneyNumberRef} label="e-Money Number" id="eMoneyNumber" placeholder="238521993" value={formCheckout.eMoneyNumber} handleValue={handleChange} errorMessage={formErrors.eMoneyNumber} required={selectedPayment === 'eMoney'} />
                <InfoInput ref={eMoneyPinRef} label="e-Money Pin" id="eMoneyPin" placeholder="6891" maxLength={4} value={formCheckout.eMoneyPin} handleValue={handleChange} errorMessage={formErrors.eMoneyPin} required={selectedPayment === 'eMoney'} />
              </div>
            )}
          </fieldset>
        </div>
