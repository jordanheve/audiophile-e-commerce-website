...
export default function ProductShowcase() {
  ...
  <div className="relative h-80 flex items-center overflow-hidden rounded-lg">
    ...
    <div className="z-10 relative ml-4 lg:ml-24" >
  ...
  <div className="lg:flex lg:gap-2">
    ...
    <div className="mt-4 w-full  bg-zinc-100 rounded-lg h-52 flex flex-col justify-center p-4 gap-8 lg:w-1/2 lg:h-auto lg:mt-0  lg:p-16">
