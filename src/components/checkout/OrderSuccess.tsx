    ...
    <>
      <Dialog open={isOpen} onClose={handleClose}>
        ...
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4 z-[101] overflow-auto">
          <DialogPanel
            transition
            className="max-w-lg space-y-6 flex flex-col  text-start font-manrope mx-4 rounded-lg bg-white px-6 py-8 duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0"
          >
            <img
            ...
            <div className="rounded-lg overflow-hidden">
              <div className="bg-[#F1F1F1] p-6 ">
                ...
                {itemsQuantity > 0 ? (
                  <>
                    <hr className=" border-b-zinc-300 mt-3 mb-3"/>
